...
class Meteorito: Sprite, Identifiable {
    ...
    private enum Constants {
        ...
        static let zigzagMinLevel: Int = 1
    ...
    private func configureZigzag(width: CGFloat) {
        ...
        initialX = center.x
        speed *= Constants.zigzagSpeedMultiplier * 0.7  // Reducido para hacer el zigzag más pronunciado
        imageName = "meteor2"
        puntosPorSalida = 3
    }
    ...
    private func updatePosition() {
        if isZigzag {
            // Solo movimiento zigzag para meteor2
            elapsedTime += 0.016
            ...
            // Movimiento vertical más lento para compensar el zigzag
            center.y += speed * 0.5
        } else {
            // Movimiento normal para otros meteoritos
            center.y += speed
        }
    }
