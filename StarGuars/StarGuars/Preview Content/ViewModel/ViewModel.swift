...
class ViewModel: ObservableObject {
    ...
    private enum GameConstants {
        static let baseSpawnInterval: Double = 1.2
        static let levelIncrease: Double = 0.04
        static let maxSpawnInterval: Double = 1.8
        static let minSpawnInterval: Double = 0.7
