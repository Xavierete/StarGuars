            ...
            ZStack {
                ...
                if !showStartSheet {  // Solo mostramos los obstáculos si el juego ha comenzado
                    ForEach(viewModel.obstacles) { obstacle in
                        Image(obstacle.imageName ?? (obstacle.isZigzag ? "meteor2" : "meteor"))
                            .resizable()
                ...
                ToolbarItem(placement: .navigationBarLeading) {
                    HStack(spacing: 4) {
                        ...
                        Button(action: {
                            ...
                            let musicFeedback = UIImpactFeedbackGenerator(style: .medium)
                            musicFeedback.prepare()
                        ...
                        Button(action: {
                            ...
                            let soundFeedback = UIImpactFeedbackGenerator(style: .medium)
...
struct InfoView: View {
    ...
    var body: some View {
        NavigationView {
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    InfoCard(
                        ...
                        description: "Los meteoritos grandes valen más puntos.\nLos zigzag son más impredecibles, ¡ten cuidado!",
                        useCustomImage: true
                    )
            ...
            .navigationTitle("Consejos para jugar StarGuars")
